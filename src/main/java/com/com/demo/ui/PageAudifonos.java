...
public class PageAudifonos {
    ...
    public static Target TEXTO = Target.the("Ver el texto del elemento").located(By.xpath("//*[@id=\"__next\"]/main/section[4]/div/div[2]/div[2]/div[2]/ul/li[" + randomNumber +"]/article/div[1]/div[2]/a/div/p"));
    ...
    public static Target PRECIO_PRODUCTO = Target.the("Ver el precio del producto").located(By.xpath("//*[@id=\"__next\"]/main/section[4]/div/div[2]/div[2]/div[2]/ul/li[" + randomNumber + "]/article/div[1]/div[2]/div/div/div[2]/p"));
